# --------- PACKAGE SETUP ---------
required_packages <- c("readr", "readxl", "tidyverse", "openxlsx", "stringr", "tibble")
...
# --------- DATA IMPORT ---------
# croplist = updated forages croplist; datasets are re-processed with new forages added, standardized and filtered
combined_allcrops <- read_csv('../../GCCSmetricsI/Data_processing/3_post_taxa_standardization_processing/Resulting_datasets/2025_11_18/combined_df.csv')
SGSV_allcrops <- read_csv('../../GCCSmetricsI/Data_processing/3_post_taxa_standardization_processing/Resulting_datasets/2025_11_18/SGSV_processed.csv')
GLIS_dataset <- read_csv('../../GCCSmetricsI/Data_processing/3_post_taxa_standardization_processing/Resulting_datasets/2025_11_18/GLIS_processed.csv')
BGCI_allcrops <- read_csv('../../GCCSmetricsI/Data_processing/3_post_taxa_standardization_processing/Resulting_datasets/2025_11_18/BGCI_processed.csv')
croplist <- read_excel("../../GCCSmetricsI/Data_processing/Support_files/GCCS_Selected_crops/croplist_PG_forages.xlsx")
...
WIEWS_regeneration_summary <- read_csv("../../GCCSmetricsI/Data_processing/1_merge_data/2025_11_17/WIEWS_indicator_processed.csv")
...
PTFTW_metrics <- read_excel("../../GCCSmetricsI/Data_processing/5_PTFTW_processing_and_metrics/2025_11_18/PTFTW_metrics.xlsx")
transfer_metrics <- read_excel("../../GCCSmetricsI/Data_processing/5_PTFTW_processing_and_metrics/2025_11_18/transfers_metrics_2015_2021.xlsx")
...
char_eval_summary <- summarize_char_eval("../../GCCSmetricsI/Data/Genesys/Characterization_and_evaluation_datasets/Tropical and subtropical forages")
...
# Write to Excel
write.xlsx(metrics_list, file = "../../GCCSmetricsI/Data_processing/4_estimate_metrics/2025_11_19/all_metrics_summary2.xlsx")
...
# Save to excel
write.xlsx(taxa_by_crop, file = "../../GCCSmetricsI/Data_processing/4_estimate_metrics/2025_11_19/gen_wiews_accessions_per_taxa_bycrop.xlsx")
...
extra_sheets <- list(
  ...
  No_Origin_Summary = no_origin_summary)
# Save to excel
write.xlsx(extra_sheets, "../../GCCSmetricsI/Data_processing/4_estimate_metrics/2025_11_19/all_metrics_combined_df.xlsx")
