...
## Data read in: Plants That Feed the World dataset and croplist of updated forages
indicator_file <- read_csv("../../GCCSmetricsI/Data/Plants_that_feed_the_world/Indicators/indicator_average.csv")
...
PTFTW_metrics_processed <- process_PTFTW_metrics(
  indicator_file = "../../GCCSmetricsI/Data/Plants_that_feed_the_world/Indicators/indicator_average.csv",
  croplist = "../../GCCSmetricsI/Data_processing/Support_files/GCCS_Selected_crops/croplist_PG_forages.xlsx",
  out_path = "../../GCCSmetricsI/Data_processing/5_PTFTW_processing_and_metrics/2025_11_18/PTFTW_metrics.xlsx"
)
...
croplist_file <- read_excel("../../GCCSmetricsI/Data_processing/Support_files/GCCS_Selected_crops/croplist_PG_forages.xlsx")

# Run function, specify croplist (updated forages) and output file is saved
# add folder with date of ouput run
transfer_metrics <- transfers_metrics(
  croplist_file = "../../GCCSmetricsI/Data_processing/Support_files/GCCS_Selected_crops/croplist_PG_forages.xlsx",
  out_path = "../../GCCSmetricsI/Data_processing/5_PTFTW_processing_and_metrics/2025_11_18/transfers_metrics_2015_2021.xlsx",
