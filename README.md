# REPOSITORY FOR EX SITU PGRFA METRICS, FORAGES
Repository with the methodology to produce a set of metrics on the ex-situ conservation of PGRFA.

Note: This repository is for tropical and subtropical forage crops only. This repo is for re-processing of forage crops after croplist was updated following expert guidance.
...
5)Processing Plants That Feed the World and Plant Treaty transfers data and computing relevant metrics
