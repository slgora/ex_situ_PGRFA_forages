...
PTFTW_metrics <- read_excel("../../Data_processing/5_PTFTW_processing_and_metrics/2025_11_18/PTFTW_metrics.xlsx")
transfer_metrics <- read_excel("../../Data_processing/5_PTFTW_processing_and_metrics/2025_11_18/transfers_metrics_2015_2021.xlsx")
# Read in all other metrics file
all_metrics <- "../../Data_processing/4_estimate_metrics/2025_11_19/all_metrics_summary.xlsx"
...
write_xlsx(table1_by_crop, path = "../../GCCS metrics project shared folder/Data_processing/6_generate_tables/2025_11_20/Table1_forages.xlsx")
...
# Export all crop tables into one Excel file with each crop as a tab
write_xlsx(table2_by_crop, path = "../../GCCSmetricsI/Data_processing/6_generate_tables/2025_11_20/Table2_forages.xlsx")
...
# Export all crop tables into one Excel file with each crop as a tab
write_xlsx(table3_by_crop, path = "../../GCCS metrics project shared folder/Data_processing/6_generate_tables/2025_11_20/Table3_forages.xlsx")
...
# Export all crop tables into one Excel file with each crop as a tab
write_xlsx(table4_by_crop, path = "../../GCCS metrics project shared folder/Data_processing/6_generate_tables/2025_11_20/Table4_forages.xlsx")
...
# Export all crop tables into one Excel file with each crop as a tab
write_xlsx(table5_by_crop, path = "../../GCCS metrics project shared folder/Data_processing/6_generate_tables/2025_11_20/Table5_forages.xlsx")
...
# Export all crop tables into one Excel file with each crop as a tab
write_xlsx(table6_by_crop, path = "../../GCCS metrics project shared folder/Data_processing/6_generate_tables/2025_11_20/Table6_forages.xlsx")
...
# Export all crop tables into one Excel file with each crop as a tab
write_xlsx(table7_by_crop, path = "../../GCCS metrics project shared folder/Data_processing/6_generate_tables/2025_11_20/Table7_forages.xlsx")
...
SI_table1_by_crop <- generate_si_table1(
  ...
  storage_30_or_40_metric_byinst = all_metrics$storage_30_or_40_metric_byinst)
# Export all crop tables into one Excel file with each crop as a tab
write_xlsx(SI_table1_by_crop, path = "../../GCCSmetricsI/Data_processing/6_generate_tables/2025_11_20/SI_Table1_forages.xlsx")

# ---------- SI Table 2 ------------
# Load metrics for SI Table 2
excel_path <- "../../GCCSmetricsI/Data_processing/4_estimate_metrics/2025_11_19/gen_wiews_accessions_per_taxa_bycrop.xlsx"
...
# Export all crop tables into one Excel file with each crop as a tab
write_xlsx(SI_table2_by_crop, path = "../../GCCSmetricsI/Data_processing/6_generate_tables/2025_11_20/SI_Table2_forages.xlsx")
